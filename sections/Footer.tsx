...
export default function Footer() {
  ...
  return (
    <footer 
      ref={footerRef}
      className="relative w-full bg-zinc-950 text-white overflow-hidden pt-32 pb-8 px-6 sm:px-12 md:px-16 lg:px-24 z-20 flex flex-col justify-between"
    ...
    >
      <div className="max-w-[1440px] mx-auto w-full flex flex-col md:flex-row justify-between items-start gap-16 md:gap-0 relative z-10">
        ...
        <div className="flex flex-col gap-12">
          <div className="flex items-center gap-2 font-spline text-xs uppercase text-zinc-400">
            <div className="h-2 w-2 bg-white shrink-0" />
          ...
          <div className="flex flex-col gap-2">
            <a 
              ...
              className="text-3xl md:text-5xl font-sans font-normal hover:text-zinc-400 transition-colors duration-300"
            >
              hello@horizon.com
            </a>
        ...
        <div className="flex gap-16 md:gap-24">
          <div className="flex flex-col gap-4">
            <span className="text-xs font-mono text-zinc-600 uppercase tracking-widest mb-2">Social</span>
          ...
          <div className="flex flex-col gap-4">
            <span className="text-xs font-mono text-zinc-600 uppercase tracking-widest mb-2">Studio</span>
      ...
      >
        <div 
          ref={hugeTextRef}
          className="text-[15vw] leading-[0.75] font-sans font-normal text-white text-center tracking-tighter whitespace-nowrap opacity-90"
      ...
      {/* Bottom Legal Bar */}
      <div className="w-full flex flex-col md:flex-row justify-between items-center gap-4 mt-16 md:mt-24 pt-8 border-t border-zinc-900 relative z-10 text-xs font-mono uppercase tracking-widest text-zinc-600">
